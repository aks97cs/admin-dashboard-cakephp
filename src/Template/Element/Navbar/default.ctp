    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="http://localhost/new/admin/project1/users/">
        <!--   <img src="img/logo.svg" alt="logo" /> -->
          <?=  $this->Html->image('logo.svg', ['alt' => 'logo']) ?>
        </a>
        <a class="navbar-brand brand-logo-mini" href="index.html">
          <!-- <img src="img/logo-mini.svg" alt="logo" /> -->
          <?=  $this->Html->image('logo-min.png', ['alt' => 'CakePHP']) ?>
        </a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <span class="profile-text">Hello,<?= $y ?>  !</span>
<!--               <img class="img-xs rounded-circle" src="#" alt="Profile image">
 -->            
 <?=  $this->Html->image('uploads/'.$img_name, ['alt' => 'CakePHP','class'=>'img-xs rounded-circle']); ?>
</a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item" href="http://localhost/new/admin/project1/users/logout">
                Sign Out
              </a>
            </div>
          </li>
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                <div class="profile-image">
                  ...
                  <?=  $this->Html->image('uploads/'.$img_name, ['alt' => 'CakePHP']); ?>                
                </div>
